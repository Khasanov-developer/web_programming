$(document).ready(function () {
    ...
    if (getCookie('city')!=null){
        ...
        $('#select_city option:contains('+city.toString()+')').prop('selected',true);
    }



    // function setCityInSelect(){
    //     data = {};
    //     var csrf_token = $('.section-delivery [name="csrfmiddlewaretoken"]').val();
    ...
    //             alert(response.city);
    //             $('select[name=city] option[value='+response.city+']');
    //         },
    //         error: function () {
    //         }
    //     })
